...
питона или с такой-то версии в библиотеке. Я предлагаю тут сделать то же самое. Когда мы будем создавать инстанс
осуждаемого класса к нам в логи (и в sentry) будет прилетать ошибка, что где-то все еще используется осуждаемый класс. И
так постепенно мы его везде выпилим. Реализовать это можно немного поправив метод init.
