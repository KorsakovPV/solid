...
тоже рабочий но Python предлагает ним синтаксический сахар мы его и используем. Оставим 
первый вариант.

А декоратор `abstractmethod` гарантирует что у всех методов дочернего класса будут 
...
Если мы где-то не заменили старый класс на новый у нас все рано все будет работать
так как нагрузка на AD уменьшится. А в логах мы будем видеть ошибку при каждом создании 
инстанса AuthUserAD и постепенно безболезненно выпилим его из всех возможных мест.
